        ...
        <div>
          ...
          <div className="works">
            ...
            <span className="ww-chip">
              <img src="/brands/base44.svg" alt="Base44" className="ww-wordmark" />
            </span>
            <span className="ww-chip">
              <img src="/brands/lovable.svg" alt="Lovable" />
              Lovable
            </span>
            <span className="ww-chip">
              <img src="/brands/claude.svg" alt="Claude" />
              Claude
            </span>
            <span className="ww-chip">
              <img src="/brands/cursor.svg" alt="Cursor" />
              Cursor
            </span>
